...
namespace TahelefCourse.Infra.Repository
{
    public class CourseRepository : ICourseRepository
    {
        ...
        {
            var p = new DynamicParameters();
            var result = await dbContext.Connection.QueryAsync<Category, Course, Category>("Course_Package1.GetAllCategoryCourse",
            (Category, course) =>
            {
            ...
            splitOn: "Courseid", param: null, commandType: CommandType.StoredProcedure);
